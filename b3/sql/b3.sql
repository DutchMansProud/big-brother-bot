...
INSERT INTO `groups` (id, time_edit, name, keyword, time_add, level) VALUES (512, 0, 'Super Admin', 'superadmin', UNIX_TIMESTAMP(), 100);
INSERT INTO `groups` (id, time_edit, name, keyword, time_add, level) VALUES (256, 0, 'Grand Admin', 'grandadmin', UNIX_TIMESTAMP(), 90);
INSERT INTO `groups` (id, time_edit, name, keyword, time_add, level) VALUES (128, 0, 'Senior Admin', 'senioradmin', UNIX_TIMESTAMP(), 80);
INSERT INTO `groups` (id, time_edit, name, keyword, time_add, level) VALUES (64, 0, 'Full Admin', 'fulladmin', UNIX_TIMESTAMP(), 60);
INSERT INTO `groups` (id, time_edit, name, keyword, time_add, level) VALUES (32, 0, 'Admin', 'admin', UNIX_TIMESTAMP(), 40);
INSERT INTO `groups` (id, time_edit, name, keyword, time_add, level) VALUES (16, 0, 'Moderator', 'mod', UNIX_TIMESTAMP(), 20);
INSERT INTO `groups` (id, time_edit, name, keyword, time_add, level) VALUES (8, 0, 'Member', 'member', UNIX_TIMESTAMP(), 15);
INSERT INTO `groups` (id, time_edit, name, keyword, time_add, level) VALUES (4, 0, 'Recruit', 'rec', UNIX_TIMESTAMP(), 10);
